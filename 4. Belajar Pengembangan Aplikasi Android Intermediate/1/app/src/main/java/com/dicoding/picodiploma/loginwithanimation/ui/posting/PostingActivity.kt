...
import com.dicoding.picodiploma.loginwithanimation.databinding.ActivityPostingBinding
...
class PostingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.galleryButton.setOnClickListener { startGalerry()}
    ...
    private fun uploadImage() {
        currentImageUri?.let { uri ->
            ...
            viewModel.uploadImage(imageFile, description).observe(this) { data ->
                if (data != null) {
                    when (data) {
                        is Result.Loading -> {
                            showLoading(true)
